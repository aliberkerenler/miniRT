...
TEST_CYLINDER_SRCS = tests/test_hit_cylinder.c
...
test_cylinder: libft $(VEC_OBJS) $(HIT_OBJS) src/hit_cylinder.o
	$(CC) $(CFLAGS_MATH) $(TEST_CYLINDER_SRCS) $(VEC_OBJS) $(HIT_OBJS) src/hit_cylinder.o $(LIBFT) -lm -o test_cylinder

test: test_vec3 test_sphere test_plane test_cylinder test_cylinder
...
fclean: clean
	rm -f $(NAME) test_vec3 test_sphere test_plane test_cylinder
	make -C libft fclean
